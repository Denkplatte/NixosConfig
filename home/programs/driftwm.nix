...
in
{
  ...
  home.file.".config/driftwm/config.toml".text = ''
    ...
    # --- media / hardware keys ---
    "XF86AudioRaiseVolume"  = "spawn wpctl set-volume -l 1.0 @DEFAULT_AUDIO_SINK@ 5%+ && pkill -SIGRTMIN+8 waybar"
    "XF86AudioLowerVolume"  = "spawn wpctl set-volume -l 1.0 @DEFAULT_AUDIO_SINK@ 5%- && pkill -SIGRTMIN+8 waybar"
